...
council_area = df['CouncilArea']
council_area_dummies = pd.get_dummies(council_area,dtype=float)
method = df['Method']
method_dummies = pd.get_dummies(method,dtype=float)
...
x = pd.concat([df['Rooms'],
               ...
               df['Bathroom'],
               df['Postcode'],
               council_area_dummies,
               df['Car'],
               method_dummies,
               df['Bedroom2']],axis='columns')
